function [best_sol]=PSO(Max_iter,lb,ub,dim,tst_lab,XTrain,XTest,YTrain,YTest,la,iii,ini_weight,net,pop_size,dd)
...
nPop=pop_size;        % Population Size (Swarm Size)
% PSO Parameters
w=1;            % Inertia Weight
...
for i=1:nPop
    ...
    % Evaluation
    particle(i).Cost=CostFunction(XTest,YTest,net,particle(i).Position,tst_lab,ini_weight,la,iii,dd);
